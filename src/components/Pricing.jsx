        ...
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Des tarifs transparents,</span>
            </span>{' '}
            conçus pour vous accompagner
          </h2>
          <p className="mt-4 text-lg text-slate-400">
            Que vous débutiez ou que votre activité soit déjà bien lancée, Klyx
            vous propose un abonnement adapté à vos besoins. Sans engagement,
            sans frais cachés.
          </p>
        </div>
